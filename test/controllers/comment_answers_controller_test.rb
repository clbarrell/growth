...
class CommentAnswersControllerTest < ActionController::TestCase
  ...
  test "should create comment_answer" do
    assert_difference('CommentAnswer.count') do
      post :create, comment_answer: { answer: @comment_answer.answer, date: @comment_answer.date, goal_id: @comment_answer.goal_id, question_id: @comment_answer.question_id }
    end
  ...
  test "should update comment_answer" do
    patch :update, id: @comment_answer, comment_answer: { answer: @comment_answer.answer, date: @comment_answer.date, goal_id: @comment_answer.goal_id, question_id: @comment_answer.question_id }
    assert_redirected_to comment_answer_path(assigns(:comment_answer))
  end
